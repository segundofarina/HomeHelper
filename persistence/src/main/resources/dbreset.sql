...
insert into reviews VALUES (2,1,DEFAULT,5,'Me presupuesto por una biblioteca y una mesa de hierro y madera. Fue muy rapido y claro. En 10 dias habiles recibi el mueble en mi domicilio ya que habia pedido envio. Todo excelente y exactamente como lo pedi. Vovlere a comprar.');
insert into reviews VALUES (3,1,DEFAULT,4,'Le encargue a matias una tabla de trabajo de 0. 68 x 2. 00 x 0. 77 x 0. 03 mts, con 2 caballetes y una cajonera (3 cajones), en madera de eucalipto y barnizado. Excelente trabajo. Gracias!!.');

insert into reviews VALUES (3,2,DEFAULT,3,'La verdad que estoy muy conforme con el trabajo que realizaron. Cumplieron el precio estipulado en el presupuesto. Y algunos detalles que no les correspondia los hicieron de onda. Y dejaron todo limpio y ordenado.');
insert into reviews VALUES (4,2,DEFAULT,5,'Fue una experiencia estupenda. Los contrate sin estar en el departamento, un semipiso de casi 200 mts2. Me han hecho pintura de todos los ambientes, aberturas, reparon puertas y paredes y quedo todo mas que estupendo. Muy honestos. Excelente staff de gente. Recomendado absolutamente, gracias');
insert into reviews VALUES (5,2,DEFAULT,4,'Agradezco por el trabajo realizado de colocación de revestimiento en el frente de mi casa, excelente predisposición y responsable con su trabajo. Muchas gracias!.');

insert into reviews VALUES (1,3,DEFAULT,5,'Realizo la ronovacion del cableado de toda la casa, colocando el tablero nuevo con varios circuitos. Estamos muy conformes con el trabajo y con la predisposición ante todos los pedidos. Saludos y muchas gracias.');
insert into reviews VALUES (2,3,DEFAULT,2,'Lo llamé para que venga a revisar unas cosas, el valor de la visita me pareció un exceso. $700. En parte el error fue mío por no preguntar de antemano el costo de la visita, pero nunca me imaginé que saldría ese valor. Aclaro que en la visita estuvo unos 40 min pero para diagnosticar en ningún momento se reparó nada y no se trataba de una emergencia ni nada. Estaba con luz y fue una visita programada. A su favor es amable en el trato y llegó puntual, pero desistí de hacer el trabajo con él porque ese costo de visita me hizo dudar si lo que me presupuestó también estaba inflado. Una lástima porque por el resto de las opiniones parece confiable, pero por lo menos tengan presente consultar cuánto cobra la vista.');
insert into reviews VALUES (3,3,DEFAULT,4,'Lo contacté el mismo día que necesitaba revise un problema en un departamento que debíamos entregar al día siguiente. Fue tarde a revisar, determino rápidamente el problema y nos dijo que debíamos comprar para solucionarlo. Volvió al día siguiente, acoplándose al horario nuestro y realizó el trabajo prolija y rápidamente. El pago de la mano de obra fue muy razonable. Excelente servicio, recomendable! muchas gracias!!.');
insert into reviews VALUES (4,3,DEFAULT,1,'No lo recomiendo. A favor de el, que llego a horario. Muy desprolijo, dejo todo sucio, además me dejo sin luz en el dormitorio y se fue. Me hizo comprar material eléctrico que no uso - debía volver para terminar, pero la experiencia me llevo a contratar a otro para que terminara el trabajo.');
insert into reviews VALUES (5,3,DEFAULT,4,'Lo citamos por un problema con las luces del fondo y la luz del lavadero. Solucionó todo en el momento y además hizo un par de arreglos en el interior de la casa, el precio fue justo y lo tenemos agendado como un profesional de confianza para llamar cada vez que sea necesario.');
insert into reviews VALUES (6,3,DEFAULT,5,'Todo perfecto! tenia un problema urgente de cableado. Lo llame y paso en el dia a verlo. Al dia siguiente ya estaba trabajando en el tema. Termino el trabajo en el dia, dandome una rapida solucion. Super recomendable! se pudo acomodar a mis horarios. ');
insert into reviews VALUES (7,3,DEFAULT,1,'Quede el dia anterior para que pase y presupueste un trabajo,me dijo que podia venir. Al dia siguiente lo espere y no solo no vino sino que tampoco aviso. Falte al laburo en vano. No lo recomiendo. Poco profesional y poco etico.');

insert into reviews VALUES (1,4,DEFAULT,5,'Todo 10 puntos. Muy amables y educados. Limpiaron el tanque de agua y repararon el calefon. Precio acorde y accesible. Muy agradecido. Serán recomendados.');
insert into reviews VALUES (2,4,DEFAULT,2,'Me vinieron a destapar un inodoro, estuvo 15 minutos y me cobro $3. 240. - una locura total. Su trabajo es totalmente incomprobable. Me pareció una estafa. Tengo la factura por si alguien la quiere.');
insert into reviews VALUES (3,4,DEFAULT,4,'Despues de 3 supuestos "plomeros" vinieran a ver el trabajo, llame a javier para ver que problema tenia la bomba presurizadora, no me vino con ningun cuento como los otros, me explico paso a paso el funcionamiento y que habia que hacer para repararla. Acepte el presupuesto y me la reparo en el dia, tenia los repuestos en el vehiculo, quede re conforme porque me lo soluciono rapido y barato, desarmo toda la bomba y me salio mucho mas barato que cambiarla y comprar otra. Eternamente agradecido. Saludos. Jose de caballito. Saludos!.');

insert into reviews VALUES (4,5,DEFAULT,5,'Cumplio con el horario y con el precio acordado, y lo mas importante confirmo el problema q tenia, el cual era negado por el "gasista"que realizo el trabajo. Tambien me dio tips para entender lo que se habia hecho mal y como solucionarlo,super recomendable.');
insert into reviews VALUES (5,5,DEFAULT,4,'La verdad muy conforme, se toma el tiempo para explicar cada detalle del trabajo que va a realizar. Cambio de lugar la llave de paso porque metrogas me lo requeria. Hizo el tramite y en 2 dias tenia gas de nuevo. Muy cumplidor y respetuoso. Seran tenidos en cuenta para futuros trabajos. Gracias!.');
insert into reviews VALUES (6,5,DEFAULT,5,'Hace unos meses los contrate para detectar una fuga de gas que tenia, ya habiendo probado con otros gasistas sin mucha suerte, javier lo pudo detectar con un aparato sin necesidad de andar rompiendo todo, por suerte! solucionado ese gran problema que tenia me realizaron una extencion de la red de gas para colocar una estufa la cual se coloco recientemente. Excelente trabajo, mas que conforme y agradecido a javier por lo profesional y macanudo a la hora de explicar y aconsejar sobre la solucion de dichos problemas.');
insert into reviews VALUES (7,5,DEFAULT,5,'Me resolvio una urgencia fuera de horario, con gran calidad de trabajo y mucho don de gente. Se que seguramente lo vuelva a necesitar para unas reformas mas adelante. No dudare en llamarlo con todo gusto. Recomiendo 100%');
