...
CREATE TABLE IF NOT EXISTS neighborhoods(
  ngid INTEGER GENERATED BY DEFAULT AS SEQUENCE neighborhoods_ngid_seq PRIMARY KEY,
  ngname VARCHAR(100)
);
...
CREATE TABLE IF NOT EXISTS workingzones(
  workingZoneId INTEGER GENERATED BY DEFAULT AS SEQUENCE workingzones_workingZoneId_seq PRIMARY KEY,
